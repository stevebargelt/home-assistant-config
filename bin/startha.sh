...
docker run -d --name="mqtt-int" -p 1883:1883 -v /home/steve/homeassistant/mosquitto-int.conf:/mosquitto/config/mosquitto.conf -v /mosquitto/data -v /mosquitto/log eclipse-mosquitto
